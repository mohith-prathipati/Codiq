const MODE_META = {
  manual:    { label: 'Manual Coding',    color: 'var(--lime)',   bg: 'var(--lime-dim)',           border: 'var(--lime-border)' },
  automated: { label: 'Automated Coding', color: 'var(--purple)', bg: 'rgba(167,139,250,0.08)',    border: 'rgba(167,139,250,0.2)' },
}

export default function Topbar({ onHome, mode, view }) {
...
const S = {
  ...
  back:  { width: 30, height: 30, background: 'var(--bg-input)', border: '1px solid var(--border-md)', borderRadius: 'var(--r-sm)', color: 'var(--text-secondary)', fontSize: '0.9rem', display: 'flex', alignItems: 'center', justifyContent: 'center', cursor: 'pointer', fontFamily: 'var(--font-body)', flexShrink: 0 },
  ...
  badge: { fontSize: '0.65rem', fontWeight: 600, letterSpacing: '0.08em', textTransform: 'uppercase', padding: '0.2rem 0.65rem', borderRadius: 100 },
